    ...
    <section id="contact" className="pt-20 relative">
      <div className="section-container" ref={ref}>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-3">
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(99,102,241,0.06) 0%, rgba(6,182,212,0.03) 100%)',
        ...
        >
          ...
          {/* Chữ ký cách điệu */}
          <p
            className="mt-8 text-sm md:text-base font-semibold tracking-[0.2em] uppercase flex items-center gap-3 opacity-60"
            style={{ color: 'var(--text-muted)' }}
          >
