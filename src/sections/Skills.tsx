    ...
    >
      ...
      <div className="relative z-10 flex gap-4 mt-2">
        ...
        <div className="flex-1 mt-0">
          <h4
            className="font-bold text-[16px] transition-colors duration-300"
            style={{ color: isHovered ? accent : 'var(--text)' }}
          >
            {skill.name}
          </h4>
          <p
            className="text-sm mt-1 leading-[1.4]"
    ...
    <section id="skills" className="pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background: `radial-gradient(circle, ${activeAccent} 0%, transparent 60%)`,
          }}
        />
        <div
              ...
              return (
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center justify-center gap-2 lg:gap-3 w-auto lg:w-full lg:justify-start lg:pl-0.5">
                    ...
                    >
                      <IconComp
                        className="w-5 h-5 lg:w-4.5 lg:h-4.5"
                        style={{
                          color: isActive ? accent : 'var(--text-muted)',
                        }}
                      />
                    </span>
                    <span className="text-[13px] lg:text-[14.5px] whitespace-nowrap hidden lg:block">
                      {category.name}
                    </span>
                    <ChevronRight
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        >
                          ...
                          {(() => {
                            const IconComp =
                              categoryIcons[category.icon] || Monitor;
                            return (
                              <IconComp
