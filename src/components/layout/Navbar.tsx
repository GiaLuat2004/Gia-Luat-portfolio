...
const navItems = ['about', 'skills', 'projects', 'education', 'certifications', 'goals', 'contact'] as const
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const sections = ['home', 'about', 'skills', 'projects', 'education', 'certifications', 'goals', 'contact']
